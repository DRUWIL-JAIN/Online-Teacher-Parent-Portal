<%-- 
    Document   : index
    Created on : May 1, 2021, 5:18:12 PM
    Author     : LENOVO
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"  import="pkg.*"%>
<!doctype html>
<html lang="en">
<head>
    ...
    <!--====== Title ======-->
    <title>Parent Teacher Portal</title>
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact text-lg-left text-center">
                            <ul>
                                <li><img src="images/all-icon/map.png" alt="icon"><span>Address goes here</span></li>
                                <li><img src="images/all-icon/email.png" alt="icon"><span>yourid@gmail.com</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="support-button float-right d-none d-md-block">
                            <div class="support float-left">
                                <div class="icon">
                                   <img src="images/ban5.jpg" alt="Logo">
                                </div>
                                <div class="cont">
                                    <img src="images/phone.png" alt="">
                                    8999598303<p>Need Help? call us free</p>
                                    
                                </div>
                            </div>
                            <div class="">
                                <a href="index.jsp" class="main-btn2">Admin Login</a>
                            </div>
                             <div class="button float-left">
                                 <a href="#" class="main-btn1">Teacher Login</a>
                             </div>
                             
                                  
                        </div>
                        <div class="button float-left">
                                 <a href="index3.jsp" class="main-btn">Parent Login</a>
                             </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="section-title mt-50">
                        <h5>About us</h5>
                        <h2>Welcome to Parent Teacher Portal </h2>
                    </div> <!-- section title -->
                    <div class="about-cont">
                        <p>This project is designed09-=</p>
    ...
    <script src="js/map-script.js"></script>
     ...
     <%     
        System.out.println("dfdf dfd dsfds sdfsd");
        //parentlogin n =new parentlogin();
